...
export default function PortfolioDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-slate-300 font-sans selection:bg-blue-500/30 relative overflow-x-hidden">
      <NavBar />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-24 space-y-20 relative z-0">
        ...
        <section className="space-y-8 relative">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="h-[1px] flex-grow bg-blue-500/20 hidden sm:block"></div>
            <span className="text-blue-500 font-mono text-[10px] border border-blue-500/90 px-2 py-0.5 animate-pulse">NVIDIA_SYSTEMS_ACTIVE</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#050505] border border-slate-800 rounded-sm overflow-hidden font-mono shadow-2xl group hover:border-blue-500/30 transition-all">
              ...
              <div className="p-4 sm:p-8 text-[11px] leading-relaxed overflow-x-auto">
            ...
            <div className="flex flex-col justify-center space-y-6">
              <h3 className="text-2xl sm:text-3xl font-bold text-white tracking-tight leading-none">Generative AI & Infrastructure</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/[0.02] border border-slate-800 p-4 sm:p-6 rounded-sm">
        ...
        <section id="strategic-log" className="space-y-8 pt-10">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-4">
              <h3 className="text-white uppercase tracking-[0.1em] text-xl font-black scroll-mt-20">
                04. ARCHITECTURE_DECISION_RECORDS
              </h3>
              <div className="h-[1px] w-32 bg-blue-500/20 hidden sm:block"></div>
            </div>
          ...
          <div className="shadow-2xl shadow-blue-500/5 overflow-x-auto">
            <ArchitectureLog />
          </div>
        </section>
